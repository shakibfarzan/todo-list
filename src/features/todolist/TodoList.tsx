    ...
    <table className="mt-5">
      ...
      <tbody>
        <tr className="border-b">
          ...
          <td className="text-center font-semibold">Task 1</td>
          <td className="text-center">
            <Badge content="Paused" mode="warning" />
          </td>
          <td className="text-center font-semibold">21 October 2021</td>
          <td className="text-center font-semibold">09:30 AM</td>
          <td className="text-center">
            <PairButton />
          </td>
        </tr>
